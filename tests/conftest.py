...
def mock_app(mock_swimlane):
    return App(mock_swimlane, {'$type': 'Core.Models.Application.Application, Core',
 'acronym': 'RA',
   ...
   'children': [{'$type': 'Core.Models.Layouts.SectionLayout, Core',
    ...
    {'$type': 'Core.Models.Layouts.TabLayout, Core',
     ...
     'tabs': [{'$type': 'Core.Models.Layouts.Tabs, Core',
      ...
      {'$type': 'Core.Models.Layouts.Tabs, Core',
       'active': False,
       'children': [{'$type': 'Core.Models.Layouts.IntegrationLayout, Core',
         'col': 1,
         'helpTextType': 0,
...
def mock_record(mock_app):
    return Record(mock_app, {'$type': 'Core.Models.Record.Record, Core',
