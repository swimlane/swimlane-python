...
or download [release package](https://github.com/Swimlane/swwimlane-python/releases). See the  [documentation](http://swimlane-python-client.readthedocs.org) for more information.
